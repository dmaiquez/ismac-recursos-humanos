...
<!--     <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
	...
	<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
	  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#"><h1>Recursos Humanos</h1></a>
	...
	<div class="container-fluid" >
	  <div class="row">
	    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary" data-bs-theme="dark" >
	      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
	        <div class="offcanvas-header">
	          <h5 class="offcanvas-title" id="sidebarMenuLabel">Recursos Humanos</h5>
	        ...
	        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
	          <ul class="nav flex-column">
	            ...
	            <li class="nav-item">
	              <a class="nav-link d-flex align-items-center gap-2 " aria-current="page" href="${pageContext.request.contextPath}/asistencia/findAll">
	                <svg class="bi"><use xlink:href="#calendar3"/></svg>
	                Asistencias
	              </a>
	            </li>
	            <li class="nav-item">
	              <a class="nav-link d-flex align-items-center gap-2" href="${pageContext.request.contextPath}/contrataciones/findAll">
	                <svg class="bi"><use xlink:href="#file-earmark"/></svg>
	                Contrataciones
	              </a>
	            </li>
	            <li class="nav-item">
	              <a class="nav-link d-flex align-items-center gap-2" href="${pageContext.request.contextPath}/contratacionDetalle/findAll">
	                <svg class="bi"><use xlink:href="#file-earmark"/></svg>
	                Contratacion Detalle
	              </a>
	            </li>
	            <li class="nav-item">
	              <a class="nav-link d-flex align-items-center gap-2 active" href="${pageContext.request.contextPath}/departamentos/findAll">
	            <!--   <svg class="bi"><i class="fa-solid fa-person"></i></svg> -->
	            ...
	            <li class="nav-item">
	              <a class="nav-link d-flex align-items-center gap-2" href="${pageContext.request.contextPath}/formapago/findAll">
...
<h2>AREA DE DEPARTAMENTOS </h2>
	<button class="btn btn-primary" onclick="window.location.href ='/ismac-recursos-humanos/departamentos/findOne?&opcion=1';return false;">
 		...
 		<tbody>
 			<c:forEach var="item" items="${keyDepartamento}">
 				<tr>
 					...
 					<td>
 					<button class="btn btn-secondary"  onclick="window.location.href ='/ismac-recursos-humanos/departamentos/findOne?idDepartamento=${item.idDepartamento}&opcion=1';return false;">
 					<i class="fa-solid fa-id-card"></i> Actualizar
 					</button>
 					
 					<button  class="btn btn-danger"   onclick="window.location.href ='/ismac-recursos-humanos/departamentos/findOne?idDepartamento=${item.idDepartamento}&opcion=2';return false;">
	...
	<footer class="py-5 bg-light">
           <div class="container"><p class="m-0 text-center ">Copyright &copy; Instituto Tecnológico ISMAC - 2024</p></div>
    </footer>
